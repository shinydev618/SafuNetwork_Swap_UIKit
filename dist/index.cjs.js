...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    NFTIcon: Icon$N,
    GalleryIcon: Icon$O,
    LaunchpadIcon: Icon$P,
    GamificationIcon: Icon$Q,
    ETHIcon: Icon$R,
    InfoIcon: Icon$S,
    ContactIcon: Icon$T,
    FarmIcon: Icon$U,
...
styled.keyframes(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"], ["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"])));
...
var MenuEntry = styled__default['default'].div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: 14.63px;\n  background-color: ", ";\n\n  a {\n    color: ", ";\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n    width: 18px;\n    height: 18px;\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: 14.63px;\n  background-color: ", ";\n\n  a {\n    color: ", ";\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n    width: 18px;\n    height: 18px;\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (secondary ? "0 32px" : "0 16px 0 28px");
}, function (_a) {
    var secondary = _a.secondary, theme = _a.theme;
    return (secondary ? theme.colors.background : "transparent");
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.sidebarChildColor;
}, function (_a) {
    var theme = _a.theme;
...
var AccordionContent = styled__default['default'].div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  border-style: solid;\n  box-shadow: 4px 17px 46px 1px ", ";\n  >div {\n    background: ", ";\n    padding-left: 65px;\n    height: 30px !important;\n  }\n"], ["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  border-style: solid;\n  box-shadow: 4px 17px 46px 1px ", ";\n  >div {\n    background: ", ";\n    padding-left: 65px;\n    height: 30px !important;\n  }\n"])), function (_a) {
    ...
    var theme = _a.theme;
    return theme.colors.sidebarChildShadow;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.sidebarChildBack;
});
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry) {
        ...
        var iconElement = React__default['default'].createElement(Icon, { width: "28px", mr: "8px" });
        ...
        return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                React__default['default'].createElement(Icon, { width: "28px", mr: "8px", isActive: entry.href === location.pathname }),
...
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu, imgs = props.imgs, isDark = props.isDark;
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu, back: (!isDark && imgs) && imgs[0] },
        React__default['default'].createElement(PanelBody, __assign({}, props))));
};
var templateObject_1$C;

var Wrapper$1 = styled__default['default'].div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
styled__default['default'].nav(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  position: fixed;\n  z-index: 1;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  padding-left: calc(88px + ", "px);\n  padding-right: 18px;\n  width: 100%;\n  height: ", "px;\n  background-color: transparent;\n  >div {\n    border-bottom: solid 1.5px ", ";\n    padding-left: 12px;\n    padding-right: 12px;\n  }\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  z-index: 1;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  padding-left: calc(88px + ", "px);\n  padding-right: 18px;\n  width: 100%;\n  height: ", "px;\n  background-color: transparent;\n  >div {\n    border-bottom: solid 1.5px ", ";\n    padding-left: 12px;\n    padding-right: 12px;\n  }\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? 0 : "-" + MENU_HEIGHT + "px");
}, function (_a) {
    var active = _a.active;
    return active ? SIDEBAR_WIDTH_FULL : SIDEBAR_WIDTH_REDUCED;
}, MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
    return theme.colors.topBottomBorder;
});
...
var Menu = function (_a) {
    _a.account; _a.login; _a.logout; var isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links; _a.profile; var children = _a.children, imgProvider = _a.imgProvider;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { imgs: imgProvider && [imgProvider[2], imgProvider[3], imgProvider[4]], isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links }),
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu }, children),
            React__default['default'].createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" }))));
};
var templateObject_1$D, templateObject_2$d, templateObject_3$7, templateObject_4$3, templateObject_5$2;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { shadow1: "#afb5d0", topBottomBorder: "#5051f7", sidebarColor: "#414177", sidebarChildColor: "#050548", sidebarChildBack: "transparent", sidebarChildShadow: "rgba(6,6,56,.35)", gearBack: "#414076", background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#414076", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { shadow1: "#afb5d0", topBottomBorder: "#5051f7", sidebarColor: "#ffffff", sidebarChildColor: "#00000b", sidebarChildBack: "transparent", sidebarChildShadow: "rgba(6,6,56,.35)", gearBack: "#414076", secondary: "#9A6AFF", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#A28BD4", borderColor: "#524B63", card: "#27262c", gradients: {
